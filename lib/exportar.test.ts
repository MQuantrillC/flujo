...
const D: DatosExportacion = {
  ...
  tareas: [
    { id: 't1', equipoId: 'e1', titulo: 'Enviar propuesta, "la buena"', descripcion: 'Con Andrea\nsegunda línea', etapaId: 'p', fechaLimite: '2026-09-30', prioridad: 'alta', creadoPor: 'marco@x.com', creadoEn: Date.UTC(2026, 8, 24, 15, 0), actualizadoEn: 0, terminadoEn: null, asignados: ['marco@x.com', 'ana@x.com'], etiquetas: ['ventas', 'gcp'], enlaces: [{ url: 'https://docs.google.com/x', nombre: 'Propuesta' }], comentarios: 1, adjuntos: 0, vinculoId: null, vinculadas: 0, posicion: null },
    { id: 't2', equipoId: 'e1', titulo: 'Ordenar el drive', descripcion: '', etapaId: 'h', fechaLimite: null, prioridad: 'normal', creadoPor: 'marco@x.com', creadoEn: 0, actualizadoEn: 0, terminadoEn: Date.UTC(2026, 8, 24, 3, 30), asignados: [], etiquetas: [], enlaces: [], comentarios: 0, adjuntos: 0, vinculoId: null, vinculadas: 0, posicion: null },
  ],
