...
const D: DatosExportacion = {
  ...
  tareas: [
    ...
    { id: 't2', equipoId: 'e1', titulo: 'Ordenar el drive', descripcion: '', etapaId: 'h', fechaLimite: null, prioridad: 'normal', creadoPor: 'marco@x.com', creadoEn: 0, actualizadoEn: 0, terminadoEn: Date.UTC(2026, 8, 24, 3, 30), asignados: [], etiquetas: [], enlaces: [], comentarios: 0, adjuntos: 0, vinculoId: null, vinculadas: 0 },
  ],
