...
const R: RotulosInvitacion = {
  asunto: 'Marco te invitó a «Ventas & Co» en Flujo', hola: 'Hola,', cuerpo: 'Marco te agregó al equipo «Ventas & Co».',
  crearCuenta: 'Crea tu cuenta con este correo:', entrar: 'Entra para verlo:', boton: 'Abrir Flujo', pie: 'Si no lo esperabas, ignóralo.',
};
...
describe('invitaciones', () => {
  ...
  it('el correo escapa el HTML y elige el paso según tenga cuenta o no', () => {
    const sin = correoInvitacion(R, { email: 'ana@x.com', equipoId: 'e1', equipoNombre: 'Ventas & Co', tieneCuenta: false }, 'https://f/registro?correo=ana%40x.com&equipo=Ventas+%26+Co');
    ...
    expect(sin.html).toContain('«Ventas &amp; Co»');
    ...
    const con = correoInvitacion(R, { email: 'ana@x.com', equipoId: 'e1', equipoNombre: 'X', tieneCuenta: true }, 'https://f/e/e1');
